        ...
        <div class="directions_applications">
            ...
            <div class="news_content">
                ...
                <p class="news_content_text">
                    թեմայով սեմինար: Այն կազմակերպվել է հիբրիդային ձևաչափով, որին մասնակցել են ներկայացուցիչներ տարբեր
                    շահագրգիռ գերատեսչություններից։
                    Միջոցառման նպատակն էր երկրների միջև փորձի փոխանակումը ռիսկերի քարտեզավորման և դրանց գնահատման ոլորտում:

                    Սեմինարի ընթացքում ծրագրի եվրոպացի փորձագետները ներկայացրել են եվրոպական մի շարք երկրների փորձը տվյալ
                    բնագավառում։

                    Հայկական կողմն իր հերթին ներկայացրել է տեղական մակարդակում ռիսկի կառավարման գործում աշխարհագրական
                    տեղեկատվական համակարգի կիրառությունը, դերն ու նշանակությունը։

                    Ներկայացվել է նաև ՄԱԿ-ի Տիեզերքի և խոշոր աղետների խարտիայի հետ իրականացվող գործընթացները և դրա
                    շրջանակներում ԱԻՆ կարողությունների զարգացման հնարավորությունները։ <a href="">Ավելի մանրամասն</a>
                </p>
            </div>
            <a class="news_return_link" href=" ">Վերադառնալ ցուցակին <img
                    src="{{ asset('img/icons/link_arrow.png') }}"></a>
        </div>
    </div>
@endsection
